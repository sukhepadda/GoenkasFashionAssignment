      ...
      <div className='flex'>
        {
          imgs.map(i => (
            ...
            >
              <SwiperSlide>
                <img className='h-[435px] w-[366px] absolute z-[-1]' src={i.img1} />
                <div className='h-[435px] w-[366px] text-4xl text-white text-center grid justify-center items-center bg-black bg-opacity-50'>
                  <div className=''>
              ...
              <SwiperSlide>
                <img className='h-[435px] w-[366px] absolute z-[-1]' src={i.img2} />
                <div className='h-[435px] w-[366px] text-4xl text-white text-center grid justify-center items-center bg-black bg-opacity-50'>
                  <div className=''>
